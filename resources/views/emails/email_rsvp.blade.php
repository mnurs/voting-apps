...
<body>
  <span class="preheader">Musyawarah Nasional X Ikatan Alumni SMA Taruna Nusantara</span>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                          ...
                          <tr>
                            <td align="left">
                              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                  <tr>
                                    {{-- <td align="center"><img src="{!!$message->embedData($qr, 'QrCode.png', 'image/png')!!}"></td> --}}
                                    <td align="center"><img src="{!!$message->embedData($imageQrRsvp, 'QrCode.png', 'image/png')!!}" alt="QR Image RSVP" style="width: 120px"></td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                      ...
                      <p>&nbsp;</p>
                      <p>Nama : {{ $member_name }}</p>
                      <p>Nosis : {{ $member_nosis }}</p>
                      <p>Batch : {{ $member_batch }}</p>
                    </td>
                  </tr>
                </table>
              </td>
